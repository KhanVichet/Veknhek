<%@ Page Title="" Language="C#" MasterPageFile="~/Content.master" AutoEventWireup="true" CodeFile="Hashtage.aspx.cs" Inherits="Hashtage" %>



<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="status-box mb-3 d-flex flex-row px-3 py-2 shadow rounded-2 box_newsfeed ">
       <asp:TextBox ID="txtAreaStatus" runat="server" CssClass="form-control auto-expand me-3" 
